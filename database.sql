-- ============================================================
-- Fox Lab – Cybersecurity Awareness & Training Platform
...
INSERT INTO security_tips (title, description, icon, display_order) VALUES
...
('How AI Is Transforming Cybersecurity Defense in 2026',
 'Artificial intelligence is no longer a buzzword in cybersecurity — it is the frontline. From real-time threat detection to automated incident response, AI is reshaping how organizations defend their digital assets.',
 '<p>The cybersecurity landscape has undergone a seismic shift in 2026. Artificial intelligence is no longer a supplementary tool — it has become the backbone of modern security operations. Organizations that fail to adopt AI-driven defenses are falling dangerously behind against increasingly sophisticated threat actors.</p>
...
('The Complete Guide to Zero Trust Architecture',
 'Zero Trust is not just a buzzword — it is a fundamental shift in how we approach network security. Learn how to implement Zero Trust principles in your organization step by step.',
...
<p><strong>Phase 1 — Identity Foundation:</strong> Deploy strong multi-factor authentication and implement identity governance. This is the foundation of Zero Trust.</p>
<p><strong>Phase 2 — Device Trust:</strong> Ensure only compliant, managed devices can access resources. Implement endpoint detection and response (EDR) across all endpoints.</p>
<p><strong>Phase 3 — Network Segmentation:</strong> Implement micro-segmentation to restrict lateral movement. Each workload should operate in its own security zone.</p>
<p><strong>Phase 4 — Continuous Monitoring:</strong> Deploy SIEM and behavioral analytics to continuously verify trust throughout every session.</p>
...
('Ransomware in 2026: Evolution, Impact, and Defense Strategies',
 ...
 '<p>Ransomware continues to be the most financially devastating form of cybercrime in 2026. The FBI reports that ransomware payments exceeded $1.5 billion globally last year, with the average ransom demand reaching $2.7 million — a 300% increase from 2023.</p>
...
<p><strong>Fix:</strong> Use at least 16 characters. Consider passphrases — four or more random words strung together (e.g., "correct-horse-battery-staple").</p>
...
<p><strong>Fix:</strong> Register for breach notifications. When notified, change the compromised password immediately — and any other accounts where you used the same password.</p>',
...
<ul>
<li><strong>Email Phishing:</strong> Mass emails impersonating trusted organizations — the most common form.</li>
...
<li><strong>Suspicious sender addresses:</strong> Look carefully — "support@paypaI.com" uses a capital I, not lowercase L</li>
...
('Building Your First Home Lab for Cybersecurity Practice',
 ...
 '<p>Every cybersecurity professional needs a safe environment to practice offensive and defensive techniques. A home lab provides exactly that — a controlled space where you can break things, experiment with tools, and build real-world skills without risking production systems.</p>
...
<li><strong>Attacking:</strong> Kali Linux — the de facto standard for offensive security</li>
<li><strong>Defending:</strong> Security Onion — network security monitoring suite</li>
...
<li><strong>CISO:</strong> Chief Information Security Officer — executive leadership of security program.</li>
...
INSERT INTO phishing_scenarios (sender_email, sender_name, recipient_email, subject, email_date, body_html, cta_text, is_phishing, difficulty) VALUES
('security@paypaI-verification.com', 'PayPal Security Team', 'john.doe@company.com',
 'Urgent: Verify Your PayPal Account – Action Required NOW!!!',
 '2026-01-05 14:34:00',
...
('newsletter@techcrunch.com', 'TechCrunch Daily', 'john.doe@company.com',
 'Your Daily Tech Digest – January 12, 2026',
 '2026-01-12 07:00:00',
...
('hr-department@g00gle-careers.net', 'Google HR Department', 'john.doe@company.com',
 'Job Offer: Senior Software Engineer – $250,000/year',
 '2026-01-22 16:45:00',
...
('billing@netf1ix-account.com', 'Netflix Billing', 'john.doe@company.com',
 'Payment Failed – Your Netflix Account Will Be Suspended',
 '2026-02-01 10:30:00',
...
('noreply@zoom.us', 'Zoom', 'john.doe@company.com',
 'Cloud Recording Available: Team Standup – Feb 10',
 '2026-02-10 09:00:00',
...
INSERT INTO phishing_red_flags (scenario_id, flag_title, flag_description, flag_icon) VALUES
...
(4, 'Fake Domain', 'The domain "amaz0n-orders.com" uses a zero instead of the letter "o" — a classic typosquatting trick.', 'fas fa-exclamation-triangle'),
...
(10, 'Suspicious Domain', 'The domain "dropb0x-share.com" uses a zero instead of "o" — not the real Dropbox domain.', 'fas fa-exclamation-triangle'),
...
(12, 'Fake Bank Domain', 'The domain "bankofamerica-secure.xyz" uses a .xyz TLD — not Bank of America\'s real domain (bankofamerica.com).', 'fas fa-exclamation-triangle'),
...
(14, 'Fake Internal Domain', 'The domain "intern4l-security.com" uses "4" instead of "a" — not a real company domain.', 'fas fa-exclamation-triangle'),
...
INSERT INTO phishing_indicators (scenario_id, indicator_text, is_correct) VALUES
...
CREATE TABLE IF NOT EXISTS user_phishing_progress (
    id              INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS term_related (
    ...
    related_url VARCHAR(500) DEFAULT '#',
    FOREIGN KEY (term_id) REFERENCES terms(id) ON DELETE CASCADE
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS term_threats (
    id          INT AUTO_INCREMENT PRIMARY KEY,
    term_id     INT NOT NULL,
...
-- A
(1, 'Access Control', '/ˈæk.ses kənˈtroʊl/', 'Protocols', 'Identity & Access',
...
(2, 'Advanced Persistent Threat', '/ədˈvɑːnst pəˈsɪs.tənt θret/', 'Threats', 'Attack Types',
...
(3, 'API Security', '/eɪ.piː.aɪ sɪˈkjʊə.rɪ.ti/', 'Protocols', 'Application Security',
...
(4, 'Authentication', '/ɔːˌθen.tɪˈkeɪ.ʃən/', 'Protocols', 'Identity & Access',
...
(5, 'Authorization', '/ˌɔː.θər.aɪˈzeɪ.ʃən/', 'Protocols', 'Identity & Access',
...
(6, 'Attack Vector', '/əˈtæk ˈvek.tər/', 'Threats', 'Attack Types',
...
(7, 'Antivirus', '/ˌæn.tiˈvaɪ.rəs/', 'Tools', 'Endpoint Security',
...
-- B
(8, 'Botnet', '/ˈbɒt.net/', 'Threats', 'Attack Types',
...
(9, 'Brute Force Attack', '/bruːt fɔːrs əˈtæk/', 'Threats', 'Attack Types',
...
(10, 'Backdoor', '/ˈbæk.dɔːr/', 'Threats', 'Malware',
...
-- C
(11, 'CIA Triad', '/siː.aɪ.eɪ ˈtraɪ.æd/', 'Concepts', 'Fundamentals',
...
(12, 'Cryptography', '/krɪpˈtɒɡ.rə.fi/', 'Encryption', 'Cryptography',
...
(13, 'Cross-Site Scripting', '/krɒs saɪt ˈskrɪp.tɪŋ/', 'Threats', 'Web Vulnerabilities',
...
(14, 'CSRF', '/siː.ɛs.ɑːr.ɛf/', 'Threats', 'Web Vulnerabilities',
...
-- D
(15, 'DDoS Attack', '/diː.diː.ɒs əˈtæk/', 'Threats', 'Attack Types',
...
(16, 'Data Breach', '/ˈdeɪ.tə briːtʃ/', 'Concepts', 'Incidents',
...
(17, 'Dark Web', '/dɑːrk web/', 'Concepts', 'Internet',
...
-- E
(18, 'Encryption', '/ɪnˈkrɪp.ʃən/', 'Encryption', 'Cryptography',
...
(19, 'Endpoint Security', '/ˈend.pɔɪnt sɪˈkjʊə.rɪ.ti/', 'Tools', 'Endpoint Security',
...
(20, 'Exploit', '/ɪkˈsplɔɪt/', 'Threats', 'Attack Types',
...
-- F
(21, 'Firewall', '/ˈfaɪər.wɔːl/', 'Tools', 'Network Security',
...
-- G
(22, 'GDPR', '/dʒiː.diː.piː.ɑːr/', 'Compliance', 'Regulations',
 'The General Data Protection Regulation (GDPR) is a comprehensive data privacy law enacted by the European Union that governs how personal data of EU residents is collected, processed, stored, and shared. It came into effect on May 25, 2018.\n\nGDPR grants individuals rights including the right to access their data, the right to be forgotten, data portability, and the right to object to processing. Non-compliance can result in fines up to €20 million or 4% of global annual revenue.',
...
-- H
(23, 'Hashing', '/ˈhæʃ.ɪŋ/', 'Encryption', 'Cryptography',
 'Hashing is the process of converting input data of any size into a fixed-size string of characters using a mathematical function (hash function). Unlike encryption, hashing is a one-way process — the original data cannot be recovered from the hash.\n\nCommon hash algorithms include MD5 (deprecated for security), SHA-256, SHA-3, and bcrypt (designed for password hashing). Hashing is used for password storage, data integrity verification, and digital signatures.',
...
(24, 'Honeypot', '/ˈhʌn.i.pɒt/', 'Tools', 'Deception Technology',
...
-- I
(25, 'Intrusion Detection System', '/ɪnˈtruː.ʒən dɪˈtek.ʃən ˈsɪs.təm/', 'Tools', 'Network Security',
...
(26, 'Incident Response', '/ˈɪn.sɪ.dənt rɪˈspɒns/', 'Concepts', 'Operations',
...
-- K
(27, 'Keylogger', '/ˈkiː.lɒɡ.ər/', 'Threats', 'Malware',
...
-- M
(28, 'Malware', '/ˈmæl.weər/', 'Threats', 'Malware',
...
(29, 'Man-in-the-Middle Attack', '/mæn ɪn ðə ˈmɪd.əl əˈtæk/', 'Threats', 'Attack Types',
...
-- N
(30, 'Network Segmentation', '/ˈnet.wɜːrk ˌseɡ.menˈteɪ.ʃən/', 'Concepts', 'Network Security',
...
-- P
(31, 'Penetration Testing', '/ˌpen.ɪˈtreɪ.ʃən ˈtes.tɪŋ/', 'Concepts', 'Operations',
...
(32, 'Phishing', '/ˈfɪʃ.ɪŋ/', 'Threats', 'Social Engineering',
...
-- R
(33, 'Ransomware', '/ˈræn.səm.weər/', 'Threats', 'Malware',
 'Ransomware is a type of malware that encrypts a victim\'s files or locks them out of their system, demanding a ransom payment (typically in cryptocurrency) to restore access. Modern ransomware often employs double extortion — encrypting data and threatening to publish it.\n\nNotable ransomware families include WannaCry, REvil, LockBit, and BlackCat. Defense strategies include regular backups, network segmentation, and endpoint protection.',
...
(34, 'Risk Assessment', '/rɪsk əˈses.mənt/', 'Concepts', 'Governance',
...
-- S
(35, 'Social Engineering', '/ˈsoʊ.ʃəl ˌen.dʒɪˈnɪr.ɪŋ/', 'Threats', 'Social Engineering',
...
(36, 'SQL Injection', '/ˌes.kjuː.ˈel ɪnˈdʒek.ʃən/', 'Threats', 'Web Vulnerabilities',
...
(37, 'SSL/TLS', '/ˌes.es.ˈel tiː.el.ˈes/', 'Encryption', 'Protocols',
...
(38, 'SIEM', '/sɪm/', 'Tools', 'Security Operations',
...
-- T
(39, 'Threat Intelligence', '/θret ɪnˈtel.ɪ.dʒəns/', 'Concepts', 'Operations',
...
(40, 'Two-Factor Authentication', '/tuː ˈfæk.tər ɔːˌθen.tɪˈkeɪ.ʃən/', 'Protocols', 'Identity & Access',
...
-- V
(41, 'VPN', '/viː.piː.ˈen/', 'Tools', 'Network Security',
...
(42, 'Vulnerability', '/ˌvʌl.nər.əˈbɪl.ɪ.ti/', 'Concepts', 'Fundamentals',
...
-- Z
(44, 'Zero-Day', '/ˈzɪə.roʊ deɪ/', 'Threats', 'Attack Types',
...
(45, 'Zero Trust', '/ˈzɪə.roʊ trʌst/', 'Concepts', 'Architecture',
...
(46, 'HIPAA', '/ˈhɪp.ə/', 'Compliance', 'Regulations',
...
(47, 'PCI DSS', '/piː.siː.aɪ diː.ɛs.ɛs/', 'Compliance', 'Standards',
...
(48, 'SOC 2', '/sɒk tuː/', 'Compliance', 'Auditing',
 'SOC 2 (System and Organization Controls 2) is an auditing framework developed by the American Institute of CPAs (AICPA) that evaluates an organization\'s controls relevant to security, availability, processing integrity, confidentiality, and privacy — known as the Trust Services Criteria.\n\nSOC 2 reports come in two types: Type I (point-in-time assessment of control design) and Type II (assessment of control effectiveness over a period, typically 6–12 months). SOC 2 certification is increasingly required by enterprise customers when selecting SaaS vendors.',
...
(49, 'ISO 27001', '/ˌaɪ.ɛs.oʊ twɛn.tiˌsɛv.ən ˈθaʊ.zənd wʌn/', 'Compliance', 'Standards',
...
(50, 'NIST Framework', '/nɪst ˈfreɪm.wɜːrk/', 'Compliance', 'Frameworks',
...
(51, 'CCPA', '/siː.siː.piː.eɪ/', 'Compliance', 'Regulations',
...
(52, 'SOX Compliance', '/sɒks kəmˈplaɪ.əns/', 'Compliance', 'Regulations',
...
(53, 'FERPA', '/ˈfɜːr.pə/', 'Compliance', 'Regulations',
...
(54, 'CMMC', '/siː.ɛm.ɛm.siː/', 'Compliance', 'Frameworks',
...
(55, 'Data Privacy', '/ˈdeɪ.tə ˈprɪv.ə.si/', 'Compliance', 'Governance',
...
(56, 'AES', '/eɪ.iː.ɛs/', 'Encryption', 'Algorithms',
...
(57, 'RSA Encryption', '/ɑːr.ɛs.eɪ ɪnˈkrɪp.ʃən/', 'Encryption', 'Algorithms',
...
(58, 'Public Key Infrastructure', '/ˈpʌb.lɪk kiː ˈɪn.frə.strʌk.tʃər/', 'Encryption', 'Infrastructure',
...
(60, 'Symmetric Encryption', '/sɪˈmet.rɪk ɪnˈkrɪp.ʃən/', 'Encryption', 'Cryptography',
 'Symmetric encryption is a type of encryption where the same key is used for both encrypting and decrypting data. It is significantly faster than asymmetric encryption, making it the preferred choice for encrypting large volumes of data.\n\nCommon symmetric algorithms include AES (current standard), ChaCha20 (used in mobile/streaming), 3DES (legacy, being phased out), and Blowfish. The primary challenge is secure key distribution — both parties must share the secret key through a secure channel.',
...
(61, 'Asymmetric Encryption', '/ˌeɪ.sɪˈmet.rɪk ɪnˈkrɪp.ʃən/', 'Encryption', 'Cryptography',
...
(62, 'Digital Signature', '/ˈdɪdʒ.ɪ.təl ˈsɪɡ.nə.tʃər/', 'Encryption', 'Authentication',
 'A digital signature is a mathematical scheme for verifying the authenticity and integrity of digital messages or documents. It uses asymmetric cryptography — the signer creates a signature with their private key, and anyone can verify it using the signer\'s public key.\n\nDigital signatures provide authentication (proof of signer identity), integrity (proof data has not been altered), and non-repudiation (signer cannot deny signing). Common standards include RSA-PSS, ECDSA, and EdDSA. They are used in code signing, email (S/MIME), PDF documents, and blockchain transactions.',
...
(63, 'Key Management', '/kiː ˈmæn.ɪdʒ.mənt/', 'Encryption', 'Infrastructure',
 'Key management encompasses the processes and procedures for generating, distributing, storing, rotating, revoking, and destroying cryptographic keys throughout their lifecycle. Effective key management is essential — encryption is only as strong as the protection of its keys.\n\nKey management solutions include Hardware Security Modules (HSMs), cloud-based Key Management Services (KMS) like AWS KMS and Azure Key Vault, and key management protocols such as KMIP. NIST SP 800-57 provides comprehensive guidelines for key management best practices.',
...
(64, 'Elliptic Curve Cryptography', '/ɪˈlɪp.tɪk kɜːrv krɪpˈtɒɡ.rə.fi/', 'Encryption', 'Algorithms',
 'Elliptic Curve Cryptography (ECC) is an approach to public-key cryptography based on the algebraic structure of elliptic curves over finite fields. ECC provides equivalent security to RSA with significantly smaller key sizes — a 256-bit ECC key offers comparable security to a 3072-bit RSA key.\n\nECC algorithms include ECDSA (signatures), ECDH (key exchange), and EdDSA/Ed25519 (modern signatures). ECC is widely used in TLS, cryptocurrency (Bitcoin uses secp256k1), mobile devices, and IoT where computational resources are limited.',
...
(65, 'Homomorphic Encryption', '/ˌhoʊ.moʊˈmɔːr.fɪk ɪnˈkrɪp.ʃən/', 'Encryption', 'Advanced',
...
(66, 'OAuth 2.0', '/oʊ.ɔːθ tuː poɪnt oʊ/', 'Protocols', 'Authorization',
...
(67, 'HTTPS', '/ˌeɪtʃ.tiː.tiː.piː.ˈɛs/', 'Protocols', 'Web Security',
...
(68, 'DNSSEC', '/diː.ɛn.ɛs.sɛk/', 'Protocols', 'Network Security',
 'DNS Security Extensions (DNSSEC) is a suite of specifications that adds authentication and integrity to the Domain Name System (DNS). DNSSEC uses digital signatures to verify that DNS responses have not been tampered with and originate from the authoritative source.\n\nDNSSEC protects against DNS spoofing and cache poisoning attacks by creating a chain of trust from the root DNS servers down to individual domains. While DNSSEC ensures data integrity, it does not encrypt DNS queries — DNS over HTTPS (DoH) and DNS over TLS (DoT) address privacy.',
...
(69, 'LDAP', '/ˈɛl.dæp/', 'Protocols', 'Identity & Access',
...
(70, 'Kerberos', '/ˈkɜːr.bər.ɒs/', 'Protocols', 'Authentication',
 'Kerberos is a network authentication protocol that uses secret-key cryptography to provide strong authentication for client/server applications. Developed at MIT, it is the default authentication protocol for Windows Active Directory environments.\n\nKerberos uses a trusted third party — the Key Distribution Center (KDC) — consisting of an Authentication Server (AS) and a Ticket Granting Server (TGS). Users authenticate once and receive time-limited tickets (TGTs) to access multiple services without re-entering credentials (single sign-on). Kerberoasting is a common attack technique against the protocol.',
...
(71, 'SAML', '/sæm.əl/', 'Protocols', 'Authentication',
...
(72, 'IPsec', '/ˌaɪ.piːˈsek/', 'Protocols', 'Network Security',
...
(73, 'SSH', '/ɛs.ɛs.eɪtʃ/', 'Protocols', 'Remote Access',
...
(74, 'RADIUS', '/ˈreɪ.di.əs/', 'Protocols', 'Authentication',
...
(75, 'WPA3', '/ˌdʌb.əl.juː.piː.ˈeɪ θriː/', 'Protocols', 'Wireless Security',
...
(76, 'Wireshark', '/ˈwaɪər.ʃɑːrk/', 'Tools', 'Network Analysis',
...
(77, 'Nmap', '/ɛn.mæp/', 'Tools', 'Reconnaissance',
...
(78, 'Metasploit', '/ˈmet.ə.splɔɪt/', 'Tools', 'Penetration Testing',
...
(79, 'Burp Suite', '/bɜːrp swiːt/', 'Tools', 'Web Security Testing',
...
(80, 'Nessus', '/ˈnes.əs/', 'Tools', 'Vulnerability Scanning',
...
(81, 'Snort', '/snɔːrt/', 'Tools', 'Network Security',
...
(82, 'CrowdStrike Falcon', '/kraʊd.straɪk ˈfæl.kən/', 'Tools', 'Endpoint Security',
...
(83, 'SOAR', '/sɔːr/', 'Tools', 'Security Operations',
...
(85, 'Password Manager', '/ˈpæs.wɜːrd ˈmæn.ɪ.dʒər/', 'Tools', 'Identity & Access',
...
-- ----------------------------------------------------------
INSERT INTO term_related (term_id, related_title, related_url) VALUES
-- Access Control
(1, 'Authentication', 'terms.php?id=4'),
(1, 'Authorization', 'terms.php?id=5'),
(1, 'Zero Trust', 'terms.php?id=45'),
(1, 'RBAC', '#'),

-- Advanced Persistent Threat
(2, 'Zero-Day', 'terms.php?id=44'),
(2, 'Social Engineering', 'terms.php?id=35'),
(2, 'Threat Intelligence', 'terms.php?id=39'),
(2, 'Malware', 'terms.php?id=28'),

-- API Security
(3, 'Authentication', 'terms.php?id=4'),
(3, 'SSL/TLS', 'terms.php?id=37'),
(3, 'SQL Injection', 'terms.php?id=36'),
(3, 'CSRF', 'terms.php?id=14'),

-- Authentication
(4, 'Authorization', 'terms.php?id=5'),
(4, 'Two-Factor Authentication', 'terms.php?id=40'),
(4, 'Access Control', 'terms.php?id=1'),
(4, 'Phishing', 'terms.php?id=32'),

-- Authorization
(5, 'Authentication', 'terms.php?id=4'),
(5, 'Access Control', 'terms.php?id=1'),
(5, 'Zero Trust', 'terms.php?id=45'),

-- Attack Vector
(6, 'Phishing', 'terms.php?id=32'),
(6, 'Social Engineering', 'terms.php?id=35'),
(6, 'Exploit', 'terms.php?id=20'),
(6, 'Malware', 'terms.php?id=28'),

-- Antivirus
(7, 'Endpoint Security', 'terms.php?id=19'),
(7, 'Malware', 'terms.php?id=28'),
(7, 'Ransomware', 'terms.php?id=33'),

-- Botnet
(8, 'DDoS Attack', 'terms.php?id=15'),
(8, 'Malware', 'terms.php?id=28'),
(8, 'Worm', 'terms.php?id=43'),

-- Brute Force Attack
(9, 'Authentication', 'terms.php?id=4'),
(9, 'Two-Factor Authentication', 'terms.php?id=40'),
(9, 'Hashing', 'terms.php?id=23'),

-- Backdoor
(10, 'Malware', 'terms.php?id=28'),
(10, 'Exploit', 'terms.php?id=20'),
(10, 'Advanced Persistent Threat', 'terms.php?id=2'),

-- CIA Triad
(11, 'Encryption', 'terms.php?id=18'),
(11, 'Access Control', 'terms.php?id=1'),
(11, 'Risk Assessment', 'terms.php?id=34'),

-- Cryptography
(12, 'Encryption', 'terms.php?id=18'),
(12, 'Hashing', 'terms.php?id=23'),
(12, 'SSL/TLS', 'terms.php?id=37'),

-- Cross-Site Scripting
(13, 'CSRF', 'terms.php?id=14'),
(13, 'SQL Injection', 'terms.php?id=36'),
(13, 'API Security', 'terms.php?id=3'),

-- CSRF
(14, 'Cross-Site Scripting', 'terms.php?id=13'),
(14, 'SQL Injection', 'terms.php?id=36'),
(14, 'Authentication', 'terms.php?id=4'),

-- DDoS Attack
(15, 'Botnet', 'terms.php?id=8'),
(15, 'Firewall', 'terms.php?id=21'),
(15, 'Incident Response', 'terms.php?id=26'),

-- Data Breach
(16, 'GDPR', 'terms.php?id=22'),
(16, 'Incident Response', 'terms.php?id=26'),
(16, 'Encryption', 'terms.php?id=18'),
(16, 'Phishing', 'terms.php?id=32'),

-- Dark Web
(17, 'Data Breach', 'terms.php?id=16'),
(17, 'Threat Intelligence', 'terms.php?id=39'),
(17, 'Encryption', 'terms.php?id=18'),

-- Encryption
(18, 'Cryptography', 'terms.php?id=12'),
(18, 'SSL/TLS', 'terms.php?id=37'),
(18, 'Hashing', 'terms.php?id=23'),
(18, 'VPN', 'terms.php?id=41'),

-- Endpoint Security
(19, 'Antivirus', 'terms.php?id=7'),
(19, 'Malware', 'terms.php?id=28'),
(19, 'SIEM', 'terms.php?id=38'),

-- Exploit
(20, 'Zero-Day', 'terms.php?id=44'),
(20, 'Vulnerability', 'terms.php?id=42'),
(20, 'Penetration Testing', 'terms.php?id=31'),

-- Firewall
(21, 'VPN', 'terms.php?id=41'),
(21, 'Intrusion Detection System', 'terms.php?id=25'),
(21, 'Network Segmentation', 'terms.php?id=30'),

-- GDPR
(22, 'Data Breach', 'terms.php?id=16'),
(22, 'Encryption', 'terms.php?id=18'),
(22, 'Risk Assessment', 'terms.php?id=34'),

-- Hashing
(23, 'Cryptography', 'terms.php?id=12'),
(23, 'Encryption', 'terms.php?id=18'),
(23, 'Brute Force Attack', 'terms.php?id=9'),

-- Honeypot
(24, 'Intrusion Detection System', 'terms.php?id=25'),
(24, 'Threat Intelligence', 'terms.php?id=39'),
(24, 'Incident Response', 'terms.php?id=26'),

-- IDS
(25, 'Firewall', 'terms.php?id=21'),
(25, 'SIEM', 'terms.php?id=38'),
(25, 'Network Segmentation', 'terms.php?id=30'),

-- Incident Response
(26, 'Data Breach', 'terms.php?id=16'),
(26, 'SIEM', 'terms.php?id=38'),
(26, 'Threat Intelligence', 'terms.php?id=39'),
(26, 'Risk Assessment', 'terms.php?id=34'),

-- Keylogger
(27, 'Malware', 'terms.php?id=28'),
(27, 'Phishing', 'terms.php?id=32'),
(27, 'Social Engineering', 'terms.php?id=35'),

-- Malware
(28, 'Ransomware', 'terms.php?id=33'),
(28, 'Worm', 'terms.php?id=43'),
(28, 'Antivirus', 'terms.php?id=7'),
(28, 'Endpoint Security', 'terms.php?id=19'),

-- MitM
(29, 'Encryption', 'terms.php?id=18'),
(29, 'SSL/TLS', 'terms.php?id=37'),
(29, 'VPN', 'terms.php?id=41'),

-- Network Segmentation
(30, 'Firewall', 'terms.php?id=21'),
(30, 'Zero Trust', 'terms.php?id=45'),
(30, 'VPN', 'terms.php?id=41'),

-- Penetration Testing
(31, 'Vulnerability', 'terms.php?id=42'),
(31, 'Exploit', 'terms.php?id=20'),
(31, 'SQL Injection', 'terms.php?id=36'),
(31, 'Cross-Site Scripting', 'terms.php?id=13'),

-- Phishing
(32, 'Social Engineering', 'terms.php?id=35'),
(32, 'Two-Factor Authentication', 'terms.php?id=40'),
(32, 'Attack Vector', 'terms.php?id=6'),
(32, 'Data Breach', 'terms.php?id=16'),

-- Ransomware
(33, 'Malware', 'terms.php?id=28'),
(33, 'Incident Response', 'terms.php?id=26'),
(33, 'Data Breach', 'terms.php?id=16'),
(33, 'Backdoor', 'terms.php?id=10'),

-- Risk Assessment
(34, 'CIA Triad', 'terms.php?id=11'),
(34, 'Vulnerability', 'terms.php?id=42'),
(34, 'GDPR', 'terms.php?id=22'),

-- Social Engineering
(35, 'Phishing', 'terms.php?id=32'),
(35, 'Attack Vector', 'terms.php?id=6'),
(35, 'Two-Factor Authentication', 'terms.php?id=40'),

-- SQL Injection
(36, 'Cross-Site Scripting', 'terms.php?id=13'),
(36, 'API Security', 'terms.php?id=3'),
(36, 'Penetration Testing', 'terms.php?id=31'),

-- SSL/TLS
(37, 'Encryption', 'terms.php?id=18'),
(37, 'Cryptography', 'terms.php?id=12'),
(37, 'VPN', 'terms.php?id=41'),

-- SIEM
(38, 'Intrusion Detection System', 'terms.php?id=25'),
(38, 'Incident Response', 'terms.php?id=26'),
(38, 'Threat Intelligence', 'terms.php?id=39'),

-- Threat Intelligence
(39, 'SIEM', 'terms.php?id=38'),
(39, 'Incident Response', 'terms.php?id=26'),
(39, 'Advanced Persistent Threat', 'terms.php?id=2'),
(39, 'Dark Web', 'terms.php?id=17'),

-- 2FA
(40, 'Authentication', 'terms.php?id=4'),
(40, 'Phishing', 'terms.php?id=32'),
(40, 'Brute Force Attack', 'terms.php?id=9'),

-- VPN
(41, 'Encryption', 'terms.php?id=18'),
(41, 'Firewall', 'terms.php?id=21'),
(41, 'SSL/TLS', 'terms.php?id=37'),
(41, 'Zero Trust', 'terms.php?id=45'),

-- Vulnerability
(42, 'Exploit', 'terms.php?id=20'),
(42, 'Penetration Testing', 'terms.php?id=31'),
(42, 'Zero-Day', 'terms.php?id=44'),
(42, 'Risk Assessment', 'terms.php?id=34'),

-- Worm
(43, 'Malware', 'terms.php?id=28'),
(43, 'Botnet', 'terms.php?id=8'),
(43, 'Vulnerability', 'terms.php?id=42'),

-- Zero-Day
(44, 'Exploit', 'terms.php?id=20'),
(44, 'Vulnerability', 'terms.php?id=42'),
(44, 'Advanced Persistent Threat', 'terms.php?id=2'),
(44, 'Penetration Testing', 'terms.php?id=31'),

-- Zero Trust
(45, 'Access Control', 'terms.php?id=1'),
(45, 'Network Segmentation', 'terms.php?id=30'),
(45, 'Authentication', 'terms.php?id=4'),
(45, 'VPN', 'terms.php?id=41'),

-- HIPAA
(46, 'GDPR', 'terms.php?id=22'),
(46, 'Data Privacy', 'terms.php?id=55'),
(46, 'Encryption', 'terms.php?id=18'),
(46, 'Risk Assessment', 'terms.php?id=34'),

-- PCI DSS
(47, 'Encryption', 'terms.php?id=18'),
(47, 'Firewall', 'terms.php?id=21'),
(47, 'Nessus', 'terms.php?id=80'),
(47, 'SOC 2', 'terms.php?id=48'),

-- SOC 2
(48, 'ISO 27001', 'terms.php?id=49'),
(48, 'Risk Assessment', 'terms.php?id=34'),
(48, 'NIST Framework', 'terms.php?id=50'),

-- ISO 27001
(49, 'SOC 2', 'terms.php?id=48'),
(49, 'NIST Framework', 'terms.php?id=50'),
(49, 'Risk Assessment', 'terms.php?id=34'),
(49, 'GDPR', 'terms.php?id=22'),

-- NIST Framework
(50, 'ISO 27001', 'terms.php?id=49'),
(50, 'CMMC', 'terms.php?id=54'),
(50, 'Risk Assessment', 'terms.php?id=34'),
(50, 'Zero Trust', 'terms.php?id=45'),

-- CCPA
(51, 'GDPR', 'terms.php?id=22'),
(51, 'Data Privacy', 'terms.php?id=55'),
(51, 'Data Breach', 'terms.php?id=16'),

-- SOX Compliance
(52, 'SOC 2', 'terms.php?id=48'),
(52, 'Access Control', 'terms.php?id=1'),
(52, 'Risk Assessment', 'terms.php?id=34'),

-- FERPA
(53, 'HIPAA', 'terms.php?id=46'),
(53, 'Data Privacy', 'terms.php?id=55'),
(53, 'Access Control', 'terms.php?id=1'),

-- CMMC
(54, 'NIST Framework', 'terms.php?id=50'),
(54, 'ISO 27001', 'terms.php?id=49'),
(54, 'Access Control', 'terms.php?id=1'),

-- Data Privacy
(55, 'GDPR', 'terms.php?id=22'),
(55, 'CCPA', 'terms.php?id=51'),
(55, 'HIPAA', 'terms.php?id=46'),
(55, 'Encryption', 'terms.php?id=18'),

-- AES
(56, 'Symmetric Encryption', 'terms.php?id=60'),
(56, 'Encryption', 'terms.php?id=18'),
(56, 'Key Management', 'terms.php?id=63'),
(56, 'RSA Encryption', 'terms.php?id=57'),

-- RSA Encryption
(57, 'Asymmetric Encryption', 'terms.php?id=61'),
(57, 'Public Key Infrastructure', 'terms.php?id=58'),
(57, 'Elliptic Curve Cryptography', 'terms.php?id=64'),
(57, 'Digital Signature', 'terms.php?id=62'),

-- PKI
(58, 'RSA Encryption', 'terms.php?id=57'),
(58, 'Digital Signature', 'terms.php?id=62'),
(58, 'SSL/TLS', 'terms.php?id=37'),
(58, 'HTTPS', 'terms.php?id=67'),

-- End-to-End Encryption
(59, 'Encryption', 'terms.php?id=18'),
(59, 'Asymmetric Encryption', 'terms.php?id=61'),
(59, 'Key Management', 'terms.php?id=63'),

-- Symmetric Encryption
(60, 'AES', 'terms.php?id=56'),
(60, 'Asymmetric Encryption', 'terms.php?id=61'),
(60, 'Key Management', 'terms.php?id=63'),
(60, 'Encryption', 'terms.php?id=18'),

-- Asymmetric Encryption
(61, 'RSA Encryption', 'terms.php?id=57'),
(61, 'Elliptic Curve Cryptography', 'terms.php?id=64'),
(61, 'Symmetric Encryption', 'terms.php?id=60'),
(61, 'Digital Signature', 'terms.php?id=62'),

-- Digital Signature
(62, 'RSA Encryption', 'terms.php?id=57'),
(62, 'Public Key Infrastructure', 'terms.php?id=58'),
(62, 'Hashing', 'terms.php?id=23'),
(62, 'Asymmetric Encryption', 'terms.php?id=61'),

-- Key Management
(63, 'AES', 'terms.php?id=56'),
(63, 'Encryption', 'terms.php?id=18'),
(63, 'Public Key Infrastructure', 'terms.php?id=58'),

-- ECC
(64, 'RSA Encryption', 'terms.php?id=57'),
(64, 'Asymmetric Encryption', 'terms.php?id=61'),
(64, 'SSL/TLS', 'terms.php?id=37'),

-- Homomorphic Encryption
(65, 'Encryption', 'terms.php?id=18'),
(65, 'Data Privacy', 'terms.php?id=55'),
(65, 'Key Management', 'terms.php?id=63'),

-- OAuth 2.0
(66, 'SAML', 'terms.php?id=71'),
(66, 'Authentication', 'terms.php?id=4'),
(66, 'Authorization', 'terms.php?id=5'),
(66, 'API Security', 'terms.php?id=3'),

-- HTTPS
(67, 'SSL/TLS', 'terms.php?id=37'),
(67, 'Public Key Infrastructure', 'terms.php?id=58'),
(67, 'DNSSEC', 'terms.php?id=68'),

-- DNSSEC
(68, 'HTTPS', 'terms.php?id=67'),
(68, 'Digital Signature', 'terms.php?id=62'),
(68, 'Man-in-the-Middle Attack', 'terms.php?id=29'),

-- LDAP
(69, 'Kerberos', 'terms.php?id=70'),
(69, 'Authentication', 'terms.php?id=4'),
(69, 'Access Control', 'terms.php?id=1'),
(69, 'SAML', 'terms.php?id=71'),

-- Kerberos
(70, 'LDAP', 'terms.php?id=69'),
(70, 'Authentication', 'terms.php?id=4'),
(70, 'Two-Factor Authentication', 'terms.php?id=40'),
(70, 'SAML', 'terms.php?id=71'),

-- SAML
(71, 'OAuth 2.0', 'terms.php?id=66'),
(71, 'Kerberos', 'terms.php?id=70'),
(71, 'Authentication', 'terms.php?id=4'),

-- IPsec
(72, 'VPN', 'terms.php?id=41'),
(72, 'Encryption', 'terms.php?id=18'),
(72, 'SSH', 'terms.php?id=73'),
(72, 'Firewall', 'terms.php?id=21'),

-- SSH
(73, 'IPsec', 'terms.php?id=72'),
(73, 'Encryption', 'terms.php?id=18'),
(73, 'Authentication', 'terms.php?id=4'),
(73, 'VPN', 'terms.php?id=41'),

-- RADIUS
(74, 'LDAP', 'terms.php?id=69'),
(74, 'Kerberos', 'terms.php?id=70'),
(74, 'WPA3', 'terms.php?id=75'),
(74, 'Authentication', 'terms.php?id=4'),

-- WPA3
(75, 'Encryption', 'terms.php?id=18'),
(75, 'RADIUS', 'terms.php?id=74'),
(75, 'AES', 'terms.php?id=56'),

-- Wireshark
(76, 'Nmap', 'terms.php?id=77'),
(76, 'Snort', 'terms.php?id=81'),
(76, 'Intrusion Detection System', 'terms.php?id=25'),

-- Nmap
(77, 'Wireshark', 'terms.php?id=76'),
(77, 'Metasploit', 'terms.php?id=78'),
(77, 'Nessus', 'terms.php?id=80'),
(77, 'Penetration Testing', 'terms.php?id=31'),

-- Metasploit
(78, 'Nmap', 'terms.php?id=77'),
(78, 'Burp Suite', 'terms.php?id=79'),
(78, 'Penetration Testing', 'terms.php?id=31'),
(78, 'Exploit', 'terms.php?id=20'),

-- Burp Suite
(79, 'Metasploit', 'terms.php?id=78'),
(79, 'WAF', 'terms.php?id=84'),
(79, 'SQL Injection', 'terms.php?id=36'),
(79, 'Cross-Site Scripting', 'terms.php?id=13'),

-- Nessus
(80, 'Nmap', 'terms.php?id=77'),
(80, 'Vulnerability', 'terms.php?id=42'),
(80, 'PCI DSS', 'terms.php?id=47'),

-- Snort
(81, 'Intrusion Detection System', 'terms.php?id=25'),
(81, 'Firewall', 'terms.php?id=21'),
(81, 'Wireshark', 'terms.php?id=76'),
(81, 'SIEM', 'terms.php?id=38'),

-- CrowdStrike Falcon
(82, 'Endpoint Security', 'terms.php?id=19'),
(82, 'Antivirus', 'terms.php?id=7'),
(82, 'SIEM', 'terms.php?id=38'),
(82, 'SOAR', 'terms.php?id=83'),

-- SOAR
(83, 'SIEM', 'terms.php?id=38'),
(83, 'Incident Response', 'terms.php?id=26'),
(83, 'CrowdStrike Falcon', 'terms.php?id=82'),

-- WAF
(84, 'Firewall', 'terms.php?id=21'),
(84, 'SQL Injection', 'terms.php?id=36'),
(84, 'Cross-Site Scripting', 'terms.php?id=13'),
(84, 'Burp Suite', 'terms.php?id=79'),

-- Password Manager
(85, 'Two-Factor Authentication', 'terms.php?id=40'),
(85, 'Brute Force Attack', 'terms.php?id=9'),
(85, 'Authentication', 'terms.php?id=4'),
(85, 'Encryption', 'terms.php?id=18');


-- ----------------------------------------------------------
-- 7c. Term Threats
-- ----------------------------------------------------------
INSERT INTO term_threats (term_id, threat_title, threat_desc) VALUES
-- API Security
...
-- ----------------------------------------------------------
INSERT INTO term_resources (term_id, resource_title, resource_url, resource_icon) VALUES
-- Access Control
...
INSERT INTO partner_features (partner_id, feature, icon) VALUES
...
INSERT INTO partnership_benefits (title, description, icon, display_order) VALUES
...
-- ----------------------------------------------------------
CREATE OR REPLACE VIEW term_category_counts AS
